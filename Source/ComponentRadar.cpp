					...
					if (z_offset < 0)
					{
						if (max_distance > 0)
						{
							...
							if (z_offset != 0)
							{
								...
								if (scaled_size_z * entity_scaled_size > radar_scaled_size / 3.0f)
									scaled_size_z = radar_scaled_size / (3.0f * entity_scaled_size);
					...
					if (z_offset > 0)
					{
						if (max_distance > 0)
						{
							...
							if (z_offset != 0)
							{
								...
								if (scaled_size_z * entity_scaled_size > radar_scaled_size / 3)
									scaled_size_z = radar_scaled_size / (3 * entity_scaled_size);
