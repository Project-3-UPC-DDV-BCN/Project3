...
public:
	...
	enum ResourceType 
	{
		...
		PhysicsMatResource, BlastMeshResource, ShaderResource, ShaderProgramResource, SoundBankResource, GOAPGoalResource, GOAPActionResource, ProfilerResoruce, Unknown
	};
