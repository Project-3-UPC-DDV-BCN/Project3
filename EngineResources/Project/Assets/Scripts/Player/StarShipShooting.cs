...
public class StarShipShooting : TheObject {
	...
	{
		laser_factory = Self.GetComponent<TheFactory>();
                	...
                	case 0:
                        {
							...
							if(laser_factory != null && laser_spawner != null)
							{
								...
								laser_scpt.SetStringField("parent_team", Self.tag);
								laser_scpt.SetStringField("parent_team", Self.GetParent().tag);
